...
village_victory = [ "Và từ đó **{}** sống trong yên bình, không còn con sói nào nữa", "Những đêm sau đó không còn ai chết nữa, mọi người trong làng đã giết hết những con sói" ]
...
onenight_seer = ( "tiên tri", "Người này được soi chức năng của một người trong làng, hoặc soi {0.SEER_REVEAL} lá bài bên ngoài", "Hãy dùng lệnh `{1}  STT-lá-bài` để xem một lá bài bên ngoài, hoặc dùng lệnh `{0}  người-khác` để soi chức năng của họ" )
