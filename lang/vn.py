...
add_wronguse = "bạn muốn thêm chức năng gì thì phải nhắn là `{0} chức-năng`"
remove_wronguse = "bạn muốn bỏ chức năng nào thì phải nhắn là `{0} chức-năng`"
remove_notfound = "hiện tại làng không có chơi {}"
thief_wronguse = "bạn muốn tráo chức năng với ai thì phải nhắn là `{0} người-đó`"
troublemaker_wronguse = "bạn muốn tráo chức năng của những người nào thì phải nhắn là `{0} người-1 người-2`"
see_wronguse = "bạn muốn soi ai thì phải nhắn là `{0} người-đó`"
drunk_wronguse = "có {1} lá bài bên ngoài, bạn phải chọn STT lá bài từ **1** đến **{1}** và dùng lệnh `{0} STT-lá-bài` để đổi với lá của mình"
reveal_wronguse = "có {1} lá bài bên ngoài, bạn phải chọn STT lá bài từ **1** đến **{1}** và dùng lệnh `{0} STT-lá-bài` để đổi xem lá đó"
clone_wronguse = "bạn muốn nhân bản ai thì phải nhắn là `{0} người-đó`"
vote_wronguse = "bạn muốn treo cổ ai thì phải nhắn là `{0} người-đó`"
...
no_dm = "bạn không được dùng lệnh `{}` trong tin nhắn riêng"
no_wolf = "bạn không được dùng lệnh `{}` ở group sói"
no_public = "bạn không được dùng lệnh `{}` ở group chính"
