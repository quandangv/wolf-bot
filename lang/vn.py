...
onenight_seer = ( "tiên tri", "Người này được soi chức năng của một người trong làng, hoặc soi {0.SEER_REVEAL} lá bài bên ngoài", "Hãy dùng lệnh `{}  STT-lá-bài` để xem một lá bài bên ngoài, hoặc dùng lệnh `{}  người-khác` để soi chức năng của họ" )
