...
end_discussion_info = [ "Khi nào bàn luận xong, mỗi bạn hãy nhắn một lệnh `{}ngungbanluan` để quản trò biết nhé", "Chừng nào bàn xong, mọi người phải nhắn `{}ngunbanluan` để t biết nha" ]
...
remove_wronguse = "bạn muốn bỏ chức năng nào thì phải nhắn là `{}bot chức-năng`"
...
wolf_only = "lộn chỗ rồi nha! Nếu chức năng bạn cho phép `{}`, bạn phải nhắn tin o group soi"
...
role_troublemaker = ( "phá rối", "Vào ban đêm, kẻ này sẽ tráo đổi chức năng của 2 người trong làng", "Hãy dùng lệnh `{}trao người-1 người-2` để tráo chức năng của họ", "kẻ phá rối" )
